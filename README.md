...
- [18.其他](#)
  - [18.1 Django](#)
    - [18.1.0 前言](docs/18.1.0-前言.md)
    - [18.1.1 `otree`命令](docs/18.1.1-otree命令.md)
    - [18.1.2 迁移和“resetdb”](docs/18.1.2-迁移和“resetdb”.md)
    - [18.1.3 项目文件夹](docs/18.1.3-项目文件夹.md)
    - [18.1.4 服务器(Server)](docs/18.1.4-服务器(Server).md)
    - [18.1.5 模型(Models)](docs/18.1.5-模型(Models).md)
    - [18.1.6 添加定制页面&URL](docs/18.1.6-添加定制页面&URL.md)
    - [18.1.7 实时和WebSockets](docs/18.1.7-实时和WebSockets.md)
  - [18.2 本地化](#)
    - [18.2.1 更改语言设置](docs/18.2.1-更改语言设置.md)
    - [18.2.2 用多种语言编写应用](docs/18.2.2-用多种语言编写应用.md)
  - [18.3 提示和技巧](#)
    - [18.3.1 防止代码重复](docs/18.3.1-防止代码重复.md)
    - [18.3.2 提高代码性能](docs/18.3.2-提高代码性能.md)
    - [18.3.3 如果可能，使用BooleanField代替StringField](docs/18.3.3-如果可能，使用BooleanField代替StringField.md)
  - [18.4 高级功能](#)
    - [18.4.0 前言](docs/18.4.0-前言.md)
    - [18.4.1 模板](docs/18.4.1-模板.md)
    - [18.4.2 静态文件](docs/18.4.2-静态文件.md)
    - [18.4.3 等待页面](docs/18.4.3-等待页面.md)
    - [18.4.4 修改现存数据库](docs/18.4.4-修改现存数据库.md)
    - [18.4.5 货币](docs/18.4.5-货币.md)
  - [18.5 机器人：高级功能](#)
    - [18.5.0 前言](docs/18.5.0-前言.md)
    - [18.5.1 命令行机器人](docs/18.5.1-命令行机器人.md)
    - [18.5.2 命令行浏览器机器人](docs/18.5.2-命令行浏览器机器人.md)
    - [18.5.3 测试案例](docs/18.5.3-测试案例.md)
    - [18.5.4 error_fields](docs/18.5.4-error_fields.md)
    - [18.5.5 其他说明](docs/18.5.5-其他说明.md)
  - [18.6 版本历史](#)
    - [18.6.1 版本2.5](docs/18.6.1-版本2.5.md)
    - [18.6.2 版本2.4](docs/18.6.2-版本2.4.md)
    - [18.6.3 版本2.3](docs/18.6.3-版本2.3.md)
    - [18.6.4 版本2.2](docs/18.6.4-版本2.2.md)
    - [18.6.5 版本2.1](docs/18.6.5-版本2.1.md)
  - [18.7 迁移到新MTurk格式](#)
    - [18.7.0 前言](docs/18.7.0-前言.md)
    - [18.7.1 我们为什么要进行此更改？](docs/18.7.1-我们为什么要进行此更改？.md)
    - [18.7.2 如何切换到新设计？](docs/18.7.2-如何切换到新设计？.md)
